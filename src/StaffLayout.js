      ...
      <aside className="staff-sidebar">
        ...
        <div className="staff-info">
          <div
            ...
            style={{ cursor: uploadingPicture ? 'not-allowed' : 'pointer', position: 'relative' }}
...
>
        ...
        <nav className="nav-menu">
          <ul>
            ...
            {/* Other nav items here, same as your original */}
            {/* Supplies */}
            <li>
