...
function DynamicRepairForm({ initialData, onClose }) {
  ...
  const addRow = () => {
    setRows([...rows, { itemCode: '', equipmentName: '', reportDetails: '', amount: '' }]);
  };
      ...
      <div className="modal-content" style={{
                    ...
                    <tr key={globalIndex}>
                      <td style={{
                        ...
                        <input
                          type="text"
                          value={row.itemCode}
                          onChange={(e) => updateRow(globalIndex, 'itemCode', e.target.value)}
                          style={{
                            backgroundColor: row.itemCode ? '#f0f8ff' : 'transparent'
                          }}
                        />
                      </td>
                      <td style={{
                      ...
                      <td style={{
                        ...
                        <input
                          type="text"
                          value={row.reportDetails}
                          onChange={(e) => updateRow(globalIndex, 'reportDetails', e.target.value)}
                          style={{
                            backgroundColor: row.reportDetails ? '#f0f8ff' : 'transparent'
                          }}
                        />
                      </td>
                      <td style={{
        ...
        <div className="print-hidden" style={{
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            >
              🖨️ Print Repair Form ({paginatedRows.length} page{paginatedRows.length > 1 ? 's' : ''})
            </button>
          </div>
        </div>
      </div>
...
export default DynamicRepairForm;
