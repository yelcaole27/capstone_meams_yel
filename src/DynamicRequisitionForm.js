...
function DynamicRequisitionForm({ initialData, formType, onClose }) {
  ...
  const addRow = () => {
    setRows([...rows, { qty: '', unit: '', description: '', remarks: '' }]);
  };
  ...
  const isOfficeSupply = formType === 'OFFICE SUPPLIES';
      ...
      <div style={{ textAlign: 'center', marginBottom: '20px', border: 'none' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div 
              className={isOfficeSupply ? 'checkbox-filled' : ''}
              style={{
                width: '18px',
                height: '18px',
                backgroundColor: isOfficeSupply ? 'black' : 'white',
                border: '2px solid black',
                display: 'inline-block'
              }}
            ></div>
            <span style={{ fontSize: '14px', color: 'black' }}>Office Supplies</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div 
              className={!isOfficeSupply ? 'checkbox-filled' : ''}
            ...
            ></div>
            <span style={{ fontSize: '14px', color: 'black' }}>Other Supplies & Materials</span>
          </div>
        </div>
      </div>
    ...
    <div className="form-footer" style={{ marginTop: '20px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px' }}>
        <div style={{ fontSize: '12px' }}>
          ...
          <span style={{ marginLeft: '30px', fontSize: '11px', fontStyle: 'italic' }}>
                    ...
                    <tr key={globalIndex}>
                      <td style={{
                        ...
                        <input
                          type="text"
                          value={row.qty}
                          onChange={(e) => updateRow(globalIndex, 'qty', e.target.value)}
                          style={{
                            backgroundColor: row.qty ? '#f0f8ff' : 'transparent'
                          }}
                        />
                      </td>
                      <td style={{
                        ...
                        <input
                          ...
                          style={{
                            backgroundColor: row.unit ? '#f0f8ff' : 'transparent'
                          }}
                        />
                      </td>
                      <td style={{
                      ...
                      <td style={{
                        ...
                        <input
                          type="text"
                          value={row.remarks}
                          onChange={(e) => updateRow(globalIndex, 'remarks', e.target.value)}
                          style={{
                            backgroundColor: row.remarks ? '#f0f8ff' : 'transparent'
                          }}
                        />
                      </td>
...
export default DynamicRequisitionForm;
